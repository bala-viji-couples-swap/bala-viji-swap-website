...
(function () {
  ...
  function initTonightSecret() {
    ...
    const secrets = [
      ...
      'Highway piss still happens when she is truly scared. He finds it honest. <a href="stories/08-cup-morning-door-thevidiya.html">Ch.08 →</a>',
      'Sealed night: she cried because she liked it. That file is not open yet. <a href="nights.html">Sealed grid →</a>',
      'Jasmine in her hair is never for God on swap nights. <a href="stories/13-shared-bath-towel-return-karthik-dp.html">Ch.16 →</a>',
      'She practices the moan in the bathroom mirror when he is not home. <a href="index.html#chats">Chats →</a>',
      'Brothers think she is weak in maths. She is strong at lying with soft eyes. <a href="stories/13-shared-bath-towel-return-karthik-dp.html">Ch.14 →</a>',
